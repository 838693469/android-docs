...
WT_MSM_ROOT=MSM8917.LA.3.0
WT_MPSS_ROOT=MPSS.JO.3.0
WT_SECTOOLS_HOME=$WT_MSM_ROOT/common/sectools/
WT_SECIMAGE_XML_PATH=$WT_SECTOOLS_HOME/config/8917/8917_secimage.xml
WT_SECIMAGE_OUTPUT_PATH=$WT_SECTOOLS_HOME/secimage_output/8917/

SIGNED_OUT_FOLDER=signed_out_8917
...
FILE_PATH_4_DOWNLOAD=(
    ./out/boot/sbl1.mbn
    ./out/boot/prog_emmc_firehose_8917_ddr.mbn
    ./out/rpm/rpm.mbn
    ./out/tz/cmnlib.mbn
    ./out/tz/cmnlib64.mbn
    ./out/tz/devcfg.mbn
...
function wt_sign_mbn_4_download()
{
    ...
    cp ./$WT_SECIMAGE_OUTPUT_PATH/prog_emmc_firehose_ddr/prog_emmc_firehose_8917_ddr.mbn $SIGNED_OUT_FOLDER
...
{
    python $WT_SECTOOLS_HOME/sectools.py fuseblower --platform=8917 --generate --validate
}
...
function wt_build_dp_mbn()
{
    ...
    python sectools.py debugpolicy -c config/8917/8917_debugpolicy.xml -e config/8917/8917_dbgp_secimage.xml -g
    cd -
