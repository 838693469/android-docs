...
make__boot()
{
    ...
    ./build.sh TARGET_FAMILY=8937 --prod -c 2>&1 | tee -a ${BOOTLOGFILENAME}
    ./build.sh TARGET_FAMILY=8937 --prod 2>&1 | tee -a ${BOOTLOGFILENAME}
    BOOT_MAKE_RESULT=${PIPESTATUS[0]}
    
    BOOT_RELEASE_DIR=${TOPDIR}/out/boot
    rm -rf ${BOOT_RELEASE_DIR}
    mkdir -p ${BOOT_RELEASE_DIR}
    cp ${TOPDIR}/BOOT.BF.3.3/boot_images/build/ms/bin/FAASANAZ/sbl1.mbn ${BOOT_RELEASE_DIR}
    cp ${TOPDIR}/BOOT.BF.3.3/boot_images/build/ms/bin/FAADANAZ/prog_emmc_firehose_8937_ddr.mbn ${BOOT_RELEASE_DIR}
    cp ${TOPDIR}/BOOT.BF.3.3/boot_images/core/boot/secboot3/hw/msm8937/sbl1/SBL1_ASIC.elf ${BOOT_RELEASE_DIR}    
...
{   
    ...
    rm -rf ${TOPDIR}/MSM8937.LA.3.0/common/build/bin
    cd ${TOPDIR}/MSM8937.LA.3.0/common/build && python ./build.py --nonhlos
    cp ${TOPDIR}/MSM8937.LA.3.0/common/build/bin/asic/NON-HLOS.bin ${MODEM_RELEASE_DIR}
    cp ${TOPDIR}/MSM8937.LA.3.0/common/build/gpt_main0.bin ${MODEM_RELEASE_DIR}
    cp ${TOPDIR}/MSM8937.LA.3.0/common/build/gpt_backup0.bin ${MODEM_RELEASE_DIR}
    cp ${TOPDIR}/MSM8937.LA.3.0/common/build/patch0.xml ${MODEM_RELEASE_DIR}
    ...
    cp ${TOPDIR}/MSM8937.LA.3.0/common/sectools/resources/build/fileversion2/sec.dat ${MODEM_RELEASE_DIR}
...
make__rpm()
{
    ...
    cp ${TOPDIR}/RPM.BF.2.2/rpm_proc/build/ms/bin/8937/rpm.mbn ${RPM_RELEASE_DIR}
    cp ${TOPDIR}/RPM.BF.2.2/rpm_proc/core/bsp/rpm/build/8937/RPM_AAAAANAAR.elf ${RPM_RELEASE_DIR}
